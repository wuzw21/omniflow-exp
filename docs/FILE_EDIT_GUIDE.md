...
| `omniflow/functions/compiler.py` | 唯一 v2 RunLog compiler；保留 1+ 语义 Function 并确定性确保其中有一个完整轨迹 Function；写 `store.json`、`compile_report.json` 和 sibling `transfer_states.json` |
