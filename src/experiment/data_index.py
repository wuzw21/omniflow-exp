...
_ARCHIVED_MOBILEGPT_RESULT_CONTRACTS = {
    ...
    "omniflow.mobilegpt.memory.v2": {
        "mode": "direct",
        "source_method": "mobilegpt_runlog_direct_memory",
        "prep_type": "mobilegpt_runlog_direct_memory",
        "learning_mode": "mobilegpt_runlog_direct_conversion",
    },
    ...
    for store in stores:
        ...
        if (
            ...
            or any(
                ...
                or str(call.get("function_id") or "")
                not in store_payload["functions"]
                for call in source_calls
            )
        ):
            raise ValueError(f"function_store_source_calls_invalid:{task}")
...
def _refresh_data_index_unlocked(
    *,
    ...
    previous_index_path = published_path
    previous_registry = (
    ...
    registry: dict[str, Any] = {
        ...
        "inputs": {
            "source_index": str(published_path),
    ...
    _atomic_write(published_path, _json_bytes(registry))
    return registry
