...
from scripts.mobilegpt_memory_converter import (
    select_complete_function,
)
from scripts.sync_androidworld_master_progress import register_attempt_summary
...
def build_mobile_agent_v3_androidworld_command(
    ...
    *,
    ...
    runner = repo_root / "scripts" / "mobile_agent_v3_androidworld_runner.py"
    argv = [
        python_executable,
        str(runner),
