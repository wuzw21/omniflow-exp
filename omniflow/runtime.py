...
from omniflow.recall import recall_functions
    ...
    async def _execute(
        ...
        *,
        ...
        if direct_tool_call is not None:
            selected_function = self.store.get_function(direct_tool_call.name)
            resolved_arguments = dict(direct_tool_call.arguments)
