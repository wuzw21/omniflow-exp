...
GUI_AGENT_RULES = (
    ...
    "Call `finished` only when the current UI proves the full goal is complete; for list or information tasks, do not treat a partial viewport or a few matching rows as the complete answer. First establish the requested scope in the UI (for example a date/category filter), then inspect the resulting list before answering.",
