...
from omniflow.gui import constrain_open_app_tool, function_tools
from omniflow.llm_usage import LLMUsageTracker
from omniflow.model import Function, Observation, ToolCall
                ...
                "text": json.dumps(
                    {
                        ...
                        "installed_apps": dict(installed_apps or {}),
                    },
                    ensure_ascii=False,
                ),
            }
